...
static const char *increase_volume[] = {
    "pamixer", "-i", "1", "--allow-boost", "--set-limit", "200", NULL};
static const char *decrease_volume[] = {
    "pamixer", "-d", "1", "--allow-boost", "--set-limit", "200", NULL};
...
static const char *clipboard_clear[] = {"clipcatctl", "clear", NULL};
